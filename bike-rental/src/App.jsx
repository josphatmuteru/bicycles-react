...
function App() {
  const desiredBookingDuration = 1
...
const availableQuarterHourUnits = timeLineAsQuarterHourUnits.filter(quarterHourUnit => !unAvailableQuarterHourUnits.includes(quarterHourUnit)).filter(quarterHourUnit => !unAvailableQuarterHourUnits.includes(convertTimeStringToMinutesAfterMidnight(performTimeAddition(performTimeAddition('0000', quarterHourUnit / 60), desiredBookingDuration)))).filter(quarterHourUnit => quarterHourUnit > currentTimeAsMinutesAfterMidnight)
